...
describe('A MathBasic', () => {
  it('should contains add, subtract, multiply, divide function', () => {
...
describe('A add function', () => {
  ...
  it('should return a + b when given two number parameters', () => {
    ...
    expect(MathBasic.add(29, 15)).toEqual(44);
  });
});
...
describe('A subtract function', () => {
  ...
  it('should return a - b when given two number parameters', () => {
    ...
    expect(MathBasic.subtract(29, 15)).toEqual(14);
  });
});
...
describe('A multiply function', () => {
  ...
  it('should return a * b when given two number parameters', () => {
    ...
    expect(MathBasic.multiply(29, 15)).toEqual(435);
  });
});
